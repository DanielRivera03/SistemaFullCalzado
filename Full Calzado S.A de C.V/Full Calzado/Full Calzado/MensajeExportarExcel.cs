...
{
    public partial class MensajeExportarExcel : Form
    {
        public MensajeExportarExcel()
        {
            InitializeComponent();
            Opacity = .95;
        }
        // POSICION PANTALLA MENSAJE PERSONALIZADO
        private void MensajeExportarExcel_Load(object sender, EventArgs e)
        {
        ...
        // CONFIRMACION DE GENERAR ARCHIVO EXCEL
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            this.DialogResult = DialogResult.OK;
        }
        // RECHAZAR GENERAR ARCHIVO EXCEL
