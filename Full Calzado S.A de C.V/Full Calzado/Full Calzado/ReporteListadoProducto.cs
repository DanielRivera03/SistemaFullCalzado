...
{
    public partial class ReporteListadoProducto : Form
    {
        /*********************************************************************************************
       ...
       *********************************************************************************************/
        ...
        private void ReporteListadoProducto_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'DatosProductosFC.ListadProductos' Puede moverla o quitarla según sea necesario.
            this.ListadProductosTableAdapter.Fill(this.DatosProductosFC.ListadProductos);
