...
{
    public partial class ConsultaEmpleadosAmpliada : Form
    {
        /*********************************************************************************************
       ...
       *********************************************************************************************/
        ...
        public ConsultaEmpleadosAmpliada()
        {
            InitializeComponent();
            DetallesSimplesEmpleados.DataSource = integracion.SelectDataTable("SELECT * FROM vEmpleadoSistema"); // DATAGRIDVIEW PRODUCTOS
        }
        /*
            --> MINIMIZAR VENTANA 
        */
        ...
        */
        ...
        // EVENTO ARRASTRE DE FORMULARIOS -> ALGUNOS ELEMENTOS
        ...
        // EVENTO ARRASTRE DE FORMULARIOS -> ALGUNOS ELEMENTOS
        private void ContenedorConsultaAvanzada_MouseDown(object sender, MouseEventArgs e)
        {
            // HABILITANDO FUNCION DE ARRASTRE DE FORMULARIO
            ReleaseCapture();
            SendMessage(this.Handle, 0x112, 0xf012, 0);
        ...
        /*
            --> BUSQUEDA AVANZADA USUARIOS 
        */
        private void txtIdProducto_KeyUp(object sender, KeyEventArgs e)
        {
            DetallesSimplesEmpleados.DataSource = integracion.SelectDataTable("SELECT * FROM vEmpleadoSistema WHERE Id_empleado LIKE ('" + txtIdProducto.Text + "%')");
        }
    }
}
