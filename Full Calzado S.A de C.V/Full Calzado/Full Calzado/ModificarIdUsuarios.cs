...
{
    public partial class ModificarIdUsuarios : Form
    {
        ...
        */
        ...
        private void btnIDUsuarios_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtIdUsuarios.Text.Length == 0)
                {
                ...
                }else if(txtIdUsuarios.Text == txtNuevoIDUsuarios.Text)
                {
                ...
                else
                {
                    ...
                    string query = "UPDATE Usuarios SET ID_usuario = "+ txtNuevoIDUsuarios.Text+" WHERE ID_usuario = "+txtIdUsuarios.Text+"";
                    SqlCommand comando = new SqlCommand(query, Controlador.Conexiones());               // CREANDO COMANDO DE CONEXION
                    comando.Parameters.AddWithValue(""+txtIdUsuarios.Text+"",txtNuevoIDUsuarios.Text);   // NUEVO ID USUARIO   
        ...
        // METODO DE LIMPIEZA TEXTBOX
        public void LimpiezaUsuarios()
        {
            txtIdUsuarios.Clear(); txtNuevoIDUsuarios.Clear();
        }
        ...
        private void txtIdUsuarios_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                btnIDUsuarios_Click(this, new EventArgs());
            }
        }
    }
}
