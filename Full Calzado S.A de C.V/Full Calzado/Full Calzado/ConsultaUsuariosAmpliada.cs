...
{
    public partial class ConsultaUsuariosAmpliada : Form
    {
        /*********************************************************************************************
        ...
        *********************************************************************************************/
        ...
        public ConsultaUsuariosAmpliada()
        {
            InitializeComponent();
        ...
        */
        ...
        private void ContenedorVista_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        */
        ...
        private void txtIdUsuarios_KeyUp(object sender, KeyEventArgs e)
        {
            DetallesSimplesUsuarios.DataSource = integracion.SelectDataTable("SELECT * FROM vUsuariosRegistrados WHERE ID_usuario LIKE ('" + txtIdUsuarios.Text + "%')");
        }
    }
}
