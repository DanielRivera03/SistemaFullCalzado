...
{
    public partial class ConsultaProductoAmpliadaBoton : Form
    {
        /*********************************************************************************************
       ...
       *********************************************************************************************/
        ...
        public ConsultaProductoAmpliadaBoton()
        {
            InitializeComponent();
            DetallesSimplesProducto.DataSource = integracion.SelectDataTable("SELECT * FROM vProductoSistema"); // DATAGRIDVIEW PRODUCTOS
        }
        /*
            --> MINIMIZAR VENTANA 
        */
        ...
        */
        ...
        {
            DetallesSimplesProducto.DataSource = integracion.SelectDataTable("SELECT * FROM vProductoSistema WHERE ID LIKE ('" + txtIdProducto.Text + "%')");
        }
    }
}
