...
{
    public partial class VentasClientesFC : Form
    {
        ...
        *********************************************************************************************/
        ...
        public VentasClientesFC(string nombre)
        {
            InitializeComponent();
            ...
            */
            ...
            // IMPORTANTE: HACER REFERENCIA ACA PARA QUE FORMULARIO DE ADMINISTRACION DE FACTURACION SE MUESTRE
            // LUEGO DE INICIAR SESION...

            // INVOCANDO FORMULARIO DE BIENVENIDA PARA USUARIOS DEPARTAMENTO RECURSOS HUMANOS
            // << EN CONSTRUCCION >> \\

            MostrarFormularios(new inicioInterfazFacturacion());
        ...
        */
        ...
        {
            Form FacturacionVista = new inicioInterfazFacturacion();
            FacturacionVista.Show();
        }
    }
}
