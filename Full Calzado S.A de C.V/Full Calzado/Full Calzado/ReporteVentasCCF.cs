...
{
    public partial class ReporteVentasCCF : Form
    {
        /*********************************************************************************************
      ...
      *********************************************************************************************/
        ...
        private void btnBuscarMes_Click(object sender, EventArgs e)
        {
            int mes;
            mes = Convert.ToInt32(txtmes.Text);
            // TODO: esta línea de código carga datos en la tabla 'datosfactura.DataTable1' Puede moverla o quitarla según sea necesario.
            this.DataTable4TableAdapter.Fill(this.datosfactura.DataTable4, mes);


            this.reportViewer1.RefreshReport();
        }

        private void ReporteVentasCCF_Load(object sender, EventArgs e)
        {
