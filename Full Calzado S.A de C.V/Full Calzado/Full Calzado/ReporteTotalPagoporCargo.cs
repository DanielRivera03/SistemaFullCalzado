...
{
    public partial class ReporteTotalPagoporCargo : Form
    {
        /*********************************************************************************************
        ...
        *********************************************************************************************/
        ...
        public ReporteTotalPagoporCargo()
        {
            InitializeComponent();
        }
        ...
        private void ReporteTotalPagoporCargo_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'DatosEmpleadosFC.REPORTEEMPLEADO' Puede moverla o quitarla según sea necesario.
            this.REPORTEEMPLEADOTableAdapter.Fill(this.DatosEmpleadosFC.REPORTEEMPLEADO);
