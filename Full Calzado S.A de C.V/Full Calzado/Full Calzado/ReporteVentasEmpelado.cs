...
{
    public partial class ReporteVentasEmpelado : Form
    {
        /*********************************************************************************************
        ...
        *********************************************************************************************/
        ...
        private void ReporteVentasEmpelado_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'DatosEmpleadosFC.ReporteVentasEmpleado' Puede moverla o quitarla según sea necesario.
            this.ReporteVentasEmpleadoTableAdapter.Fill(this.DatosEmpleadosFC.ReporteVentasEmpleado);
