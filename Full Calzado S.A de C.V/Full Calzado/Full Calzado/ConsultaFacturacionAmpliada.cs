...
{
    public partial class ConsultaFacturacionAmpliada : Form
    {
        /*********************************************************************************************
       ...
       *********************************************************************************************/
        ...
        public ConsultaFacturacionAmpliada()
        {
            InitializeComponent();
            DetallesSimplesFacturacion.DataSource = integracion.SelectDataTable("Select * from VFactura"); // DATAGRIDVIEW FACTURACION
        }
        /*
            --> MINIMIZAR VENTANA 
        */
        ...
        */
        ...
        /*
            --> BUSQUEDA AVANZADA FACTURACION
        */
        private void txtIdProducto_KeyUp(object sender, KeyEventArgs e)
        {
            DetallesSimplesFacturacion.DataSource = integracion.SelectDataTable("SELECT * FROM VFactura WHERE cod_examen LIKE ('" + txtIdProducto.Text + "%')");
        }
    }
}
