...
{
    public partial class RecursosHumanosDpto : Form
    {
        ...
        *********************************************************************************************/
        ...
        public RecursosHumanosDpto(string nombre)
        {
            InitializeComponent();
            ...
            MostrarFormularios(new InicioInterfazHHRR());
        }
       ...
       */
        ...
        */
        ...
        /*
            -> IMPORTANTE, SEGUN SU OPCION DE MENU QUE ELIGIERON, DEBERAN HACER TODOS LOS AJUSTES
            NECESARIOS PARA TODOS LOS DEMAS ROLES DE USUARIOS {NUEVOS FORMULARIOS DE GESTIONES} 
        */
        ...
        */
        ...
        private void btnReportesFC_Click(object sender, EventArgs e)
        {
            /*
                 --> ESTILOS HOVER PARA BOTONES Y TEXTO ACTIVO / INACTIVO
              */
            btnReportesFC.BackColor = Color.DarkSlateBlue;
            btnReportesFC.ForeColor = Color.WhiteSmoke;
            // ESTADO INACTIVO ↓ {TODOS} -> BOTONES
            btnEmpleadosFC.BackColor = Color.Khaki;
            btnProductosFCSistema.BackColor = Color.Khaki;
            btnFacturacionesFC.BackColor = Color.Khaki;
            ...
            btnFacturacionesFC.ForeColor = Color.Black;
            btnCerrarSesiones.ForeColor = Color.Black;
            MostrarFormularios(new FormulariosRRHH());
        }
