...
{
    public partial class ReporteMontosTotalProductos : Form
    {
        /*********************************************************************************************
       ...
       *********************************************************************************************/
        ...
        public ReporteMontosTotalProductos()
        {
            InitializeComponent();
        }

        private void ReporteMontosTotalProductos_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'DatosProductosFC.MontosTotalProductos' Puede moverla o quitarla según sea necesario.
            this.MontosTotalProductosTableAdapter.Fill(this.DatosProductosFC.MontosTotalProductos);
