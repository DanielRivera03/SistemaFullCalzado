...
{
    public partial class PresidenciaAdministracion : Form
    {
        ...
        *********************************************************************************************/
        ...
        public PresidenciaAdministracion(string nombre)
        {
            InitializeComponent();
            ...
            MostrarFormularios(new InicioInterfazPrecidencia());
        }
       ...
       */
        ...
        */
        ...
        /*
            --> CONTROLADOR TIMER HORA SISTEMA ACTUAL 
        */
        private void ControlHoraSistema_Tick_1(object sender, EventArgs e)
        {
            HoraSistema.Text = DateTime.Now.ToString();
        }
        ...
        */
        private void btnEmpleadosFC_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            btnReportesFC.BackColor = Color.Khaki;
            ...
            btnReportesFC.ForeColor = Color.Black;
            //MOSTRARA EL FORMULARIO EN EL PANEL
            MostrarFormularios(new ConsultaEmpleadosAmpliada());
        }
        ...
        */
        ...
        /*
            --> BOTON OPCION {REPORTES} 
        */
        private void btnReportesFC_Click(object sender, EventArgs e)
        {
            /*
                --> ESTILOS HOVER PARA BOTONES Y TEXTO ACTIVO / INACTIVO
           */
            btnReportesFC.BackColor = Color.DarkSlateBlue;  // ESTADO ACTIVO   
            btnReportesFC.ForeColor = Color.WhiteSmoke; // ESTADO ACTIVO
            // ESTADO INACTIVO ↓ {TODOS} -> BOTONES
            btnEmpleadosFC.BackColor = Color.Khaki;
            btnProductosFCSistema.BackColor = Color.Khaki;
            btnFacturacionesFC.ForeColor = Color.Khaki;
            btnCerrarSesiones.BackColor = Color.Khaki;
            // ESTADO INACTIVO ↓ {TODOS} -> TEXTO
            btnEmpleadosFC.ForeColor = Color.Black;
            btnProductosFCSistema.ForeColor = Color.Black;
            ...
            btnCerrarSesiones.ForeColor = Color.Black;
            //MOSTRARA EL FORMULARIO EN EL PANEL
            MostrarFormularios(new FormulariosPresidencia());
        }
