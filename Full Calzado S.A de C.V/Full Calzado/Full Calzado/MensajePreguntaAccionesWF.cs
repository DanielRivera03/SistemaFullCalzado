...
{
    public partial class MensajePreguntaAccionesWF : Form
    {

        public MensajePreguntaAccionesWF()
        {
            InitializeComponent();
            Opacity = .95;
        }
        ...
        private void MensajePreguntaAccionesWF_Load(object sender, EventArgs e)
        {
        ...
        // CONFIRMACION DE DEPURACION DE REGISTRO
