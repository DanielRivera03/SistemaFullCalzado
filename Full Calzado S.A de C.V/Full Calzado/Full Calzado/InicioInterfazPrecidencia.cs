...
{
    public partial class InicioInterfazPrecidencia : Form
    {
        public InicioInterfazPrecidencia()
        {
            InitializeComponent();
        }

        private void ContenedorPrincipalSecundario_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            Form EmpleadoVista = new ListadoPersonalizadoEmpleados();
            EmpleadoVista.Show();
        }

        private void btnReportesProducto_Click(object sender, EventArgs e)
        {
            Form Productovista = new ListadoPersonalizadoProductos();
            Productovista.Show();
        }

        private void btnFacturaProductos_Click(object sender, EventArgs e)
        {
            Form FacturaVista = new ListadoDetalladoFactura();
            FacturaVista.Show();
        }
    }
}
